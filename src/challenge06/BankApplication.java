...
public class BankApplication {
  ...
  static challenge06.BankAccount[] bankAccounts = new challenge06.BankAccount[100];
  ...
  static void createAccount() {
    ...
    for (int i = 0; i < bankAccounts.length; i++) {     // for문을 돌리면서 빈 공간이 있으면 값을 넣고 빠져나오게 설정
      if (bankAccounts[i] == null) {
        // 동일 계좌가 있다면 실행 X
        challenge06.BankAccount bankAccount = new challenge06.BankAccount(accountNo, accountOwner, balance);    // 외부 필드 사용
